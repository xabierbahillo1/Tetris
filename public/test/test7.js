...
// clear the canvas
    ...
    QUnit.test('Testing grid', function(assert) {
        ...
        assert.pixelEqual(canvas, 30*4+15, 30*4+15, 0, 128, 0, 255, "Green al moverser 4 veces hacia abajo")
    ...
    QUnit.test('Sale pieza nueva', function(assert) {
        ...
        assert.pixelEqual(canvas, 30*5+15, 15, 0, 128, 0, 255, "Green en la parte superior");
